...
Note: This version is the same as [react-html-email](https://github.com/chromakode/react-html-email). It just includes a fix for browser support using babel-preset-env.
